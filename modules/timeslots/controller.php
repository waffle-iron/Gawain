...
$app->group('/timeslots', function () use ($app, $loader, $obj_Jierarchy, $str_SessionID) {
	...
	$app->post('/:timeslotID/save', function ($timeslotID) use ($app, $str_SessionID) {
		...
		// Save activity data
		$obj_Timeslot->update($timeslotID, $arr_PostVariables);
		$app->redirect($app->urlFor('timeslots'));

	})->conditions(array('timeslotID' => '\d+'))->name('timeslot_edit_save');
